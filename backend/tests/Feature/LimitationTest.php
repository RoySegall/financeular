...
class LimitationTest extends TestCase
{
    ...
    public function testLimitationFromTwoFiles() {
        ...
        $limitation_from_first_file = $this->firstFile->limitations()->first();
        ...
        $this->assertNotEquals($limitation_from_first_file->id, $limitations_from_second_file->id);
        $this->assertEquals($limitation_from_first_file->id, $first_limitation->id);
