...
export default () => <>
  ...
  <p className="text-center pt-10 pb-10 text-2xl font-thin">
    We could not found files. You can <Link to="/upload">upload</Link> some files and get some interesting insights,
